...
let description = document.getElementById('descrpition')
...
const ecyclopedie = {
    ...
    "Hanche": "La hanche ou articulation coxo-fémorale est une articulation (sphéroïde) qui permet de joindre la cuisse au bassin. Elle met en jeu deux os : l'os coxal et le fémur. ",
    ...
    circle.addEventListener('mouseover', function () {
        ...
        switch (limb) {
            ...
            case 'hips':
                    ...
                    limbField.innerHTML = limbNames.filter( (name) =>  { return name === "Hanche" } )+":"

                    description.innerHTML = ecyclopedie.Hanche
